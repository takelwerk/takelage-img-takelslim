...
namespace :images do
  ...
  images.each do |project_image|
    ...
    keep_interim_images = images[image]['keep_interim_images'].nil? || images[image]['keep_interim_images']
        ...
        namespace :build do
          namespace :layer do
            ...
            layers.each_with_index do |layer, index|
              ...
              var_version = ''
              if @project.key?('version')
                var_version = "-var='version=#{@project['version']}' "
              end
